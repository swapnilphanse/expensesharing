        ...
        <div class="col-md-5 ml-auto">
            <div class="info-area info-horizontal mt-5">
                ...
                <div class="description">
                    <h3 class="info-title">{{ __('Register') }}</h3>
                    <p class="description">
                        {{ __('Register using your email, name and password.') }}
                    </p>
                </div>
            </div>
                ...
                <form class="form" method="post" action="{{ route('register') }}">
                    ...
                    <div class="card-body">
                        ...
                        <div class="input-group{{ $errors->has('phone') ? ' has-danger' : '' }}">
                            ...
                            <input type="tel" name="phone" class="form-control{{ $errors->has('phone') ? ' is-invalid' : '' }}" placeholder="{{ __('Phone') }}">
